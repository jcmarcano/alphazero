...
class JaipurNNet():
    ...
    def create_model(self, dropout):
        ...
        s_fc1 = Dropout(dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(512)(self.input_boards))))  # batch_size x 512
        s_fc2 = Dropout(dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(1024)(s_fc1))))  # batch_size x 512
        s_fc3 = Dropout(dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(512)(s_fc2))))  # batch_size x 512
        ...
        return Model(inputs=self.input_boards, outputs=[self.pi0, self.pi1, self.v])
