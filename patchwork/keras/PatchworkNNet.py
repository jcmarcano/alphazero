...
class PatchworkNNet():
    ...
    def __init__(self, game, args):
        ...
        self.pi0 = Dense(self.action_size[0], activation='softmax', name='pi0')(s_fc2)   # batch_size x self.action_size (market action = 32)
        self.pi1 = Dense(self.action_size[1], activation='softmax', name='pi1')(s_fc2)   # batch_size x self.action_size (player action = 128)
